...
<div class="row">
	...
	<li class="active" style="font-family:calibri; font-size:16px;"><a style="color:#000" href="supadmst.php"><strong>Staff Modifications</strong></a></li>
	</ul>
</div></div>
<br>
<br>
...
// removes backslashes
    ...
    $query = "SELECT * FROM `sup_admin` WHERE `sadusername`='$username'and `sadpassword`='".md5($password)."'";

		$result = mysqli_query($con,$query);
		$rows = mysqli_num_rows($result);
        if($rows==1){
			$_SESSION['sadmun'] = $username;
			header("Location: staffmodify.php"); // Redirect user to index.php
            }else{
