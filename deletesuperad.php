...
<ul class="nav  nav-justified" style="background-color:#FFF;">
  <li style="font-family:calibri; font-size:16px;"><a style="color:#000" href="superadmin.php"><strong>Insert Super administration</strong></a></li>
  <li class="active"  style="font-family:calibri; font-size:16px;"><a style="color:#000" href="deletesuperad.php"><strong>Delete Super administration</strong></a></li>
</ul>
<hr>
</div></div>
...
<tr valign="middle">
    ...
    <td  align="left"><?php echo $row["sadname"]; ?> </td>
    <td  align="left"><?php echo $row["sadusername"]?> </td>
	  <td  align="left"><?php echo $row["sademail"]; ?></td>
