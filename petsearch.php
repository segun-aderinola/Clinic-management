...
if (isset($_POST['filter'])){
	...
	$self_query = "SELECT * FROM `patient` WHERE concat(`pat_reg_id`, `pet_con`,`pet_em`,`pet_fn`,`pet_bg`) like '%$search%' ORDER BY `pet_id` DESC";
...
<li style="background-color:rgba(255, 255, 255, 0.3);"><a style="color:#000" target="_blank" href="admit.php?id=<?php echo $row["pet_id"]; ?>" name="ad">Admit to Hospital</a></li>
