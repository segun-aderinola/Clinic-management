...
--
-- Host: 127.0.0.1
-- Generation Time: Jun 02, 2020 at 02:12 AM
...
(4, 'aliyu salma', 20, '+234 0810888591', 'B+', '2', 2, '2020-06-01', 'malaria');
...
(2, 'Room No: 2', 'NAV', '11.30 AM', '06.30 PM', NULL, NULL, '2'),
...
(1, 'ADERINOLA', 'MAYOWA', 'Doctor', '1997-09-30', '+234', '07011201920', 'segun.aderinola16@gmail.com', 'Male', 'Full', 'flat 1, gambari, Ilorin', '9b12fd03f728c8def23d58cc9bc29619', 'segun554', '2020-04-08 11:50:17', 'yusuf.aliy', '2020-04-09 07:50:48'),
...
--
ALTER TABLE `pat_appointment`
  MODIFY `rep_id` int(50) NOT NULL AUTO_INCREMENT;
