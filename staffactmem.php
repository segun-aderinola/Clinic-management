...
<h1 class="text-center ">HKwara State University Clinic<br /><small style="font-size:20px">Hospital Management System</small></h1></div>
</div>
</div><br><br><br>
...
<div class="row">
  ...
  <li class="active" style="font-family:calibri; font-size:16px;"><a style="color:#000" href="staffactmem.php"><strong>Active Staff</strong></a></li>
  <li id="lockk" style="font-family:calibri; font-size:16px;"><a style="color:#000" href="supadmst.php"><strong>Staff Modifications</strong></a></li>
  </ul>
</div></div>
<div class="container">
<div class="row">
...
<h3 style="font-family:calibri;" class="text-center">Active Staff</h3></div>
</div>
</div>
</div>
<div class="container">
...
<tr>
    ...
    <td align="center"><?php echo $row["staff_fname"]; ?> <?php echo $row["staff_lname"]; ?></td>
