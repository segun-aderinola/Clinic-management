...
<div class="row col-md-8 col-md-offset-2 col-xs-12">
  <ul class="nav  nav-justified" style="background-color:#FFF;">
    ...
    <li class="active" style="font-family:calibri; font-size:16px;"><a style="color:#000" href="deletebasicad.php"><strong>Delete Basic administration</strong></a></li>
  </ul>
<hr>
</div></div>
...
<?php
$count=1;
$sel_query="SELECT * FROM `basic_admin` ORDER BY `basad_id` desc";
$result = mysqli_query($con,$sel_query);
while($row = mysqli_fetch_assoc($result)) { ?>
<tr valign="middle">
    <td  align="left"><strong><?php echo $count; ?></strong> </td>
    <td  align="left"><?php echo $row["basad_id"]; ?></td>
    <td  align="left"><?php echo $row["basad_name"]; ?> </td>
    <td  align="left"><?php echo $row["basad_username"]?> </td>
	  <td  align="left"><?php echo $row["basad_email"]; ?></td>
    <td  align="left"><?php echo $row["createdate"]; ?></td>
    <td  align="center"><a href="delebas.php?id=<?php echo $row["basad_id"]; ?>" name="ad">Delete</a></td>
