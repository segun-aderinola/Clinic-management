...
<li style="font-family:calibri; font-size:16px;"><a style="color:#000" href="staffdetails.php"><strong>Staff  Details</strong></a></li>
<li style="font-family:calibri; font-size:16px;"><a style="color:#000" href="staffsearch.php"><strong>Staff  Search</strong></a></li>
<li style="font-family:calibri; font-size:16px;"><a style="color:#000" href="staffactmem.php"><strong>Active Staff </strong></a></li>
<li id="lock" style="font-family:calibri; font-size:16px;"><a style="color:#000" href="supadmst.php"><strong>Staff Modifications</strong></a></li>
</ul>
</div></div>
<div class="container">
<div class="row">
...
<form id="sreg" name="sreg" action="" method="post">
  ...
  <tr>
    ...
    <div class="input-group col-md-12 col-xs-12">
      <input required pattern="[A-Za-z]{1,30}" title="Use Only Letters"  id="fname" name="fname"   type="text" class="form-control" placeholder="First Name">
	</div>
    ...
    <td colspan="2" style="padding:5px">
    <div class="input-group col-md-12 col-xs-12">
      <input required pattern="[A-Za-z]{1,30}" title="Use Only Letters" name="lname" id="lname"   type="text" class="form-control" placeholder="Last Name">
	</div>
    </td>
  </tr>
  ...
  <tr>
    <td colspan="2" style="padding:5px">
      <div class="input-group col-md-12 col-xs-12 ">
        <input name="addr"  required="required" type="text" class="form-control" placeholder="Address">
      </div>
    </td>
    </tr>
  ...
  <tr>
    <td colspan="2" style="padding:5px">
      <div class="input-group col-md-12 col-xs-12 ">
        <span style="border-radius:0px; width:10px" class="input-group-addon" id="basic-addon1">+234</span><input pattern="\d{11,11}"  maxlength="11" title="Invalid Mobile Number. Use only Letters and character count must be 11" name="tel" required  type="tel" class="form-control" placeholder="Contact Number" style="border-radius:0px">
      </div>
...
('<?php echo $emlduperr; ?>');</script></td>
  ...
  <tr>
    <td colspan="2" style="padding:5px;">
      <div class="input-group col-md-12 col-xs-12 ">
        <select name="typesm" required="required" class="form-control" placeholder="Select your Staff Type">
  ...
  <tr>
    <td colspan="2" style="padding:5px"><div class="input-group col-md-12 col-xs-12 "> Create Login Password</div>
	<script type="text/javascript">
   document.write
('<?php echo $emlduperr; ?>');</script></td>
    </tr>
  ...
  <tr>
    <td colspan="2" style="padding:5px">
      <div class="input-group col-md-12 col-xs-12 "> <input pattern="" title="" id="password" name="password" required  type="text" class="form-control" placeholder="Password" style="border-radius:0px"></div>
