...
<nav style="border-radius:0px; height:20px;background-color:#FFF" class="navbar navbar-default">
  <div class="container-fluid">
    ...
    <div class="navbar-header">
      ...
      <p class="navbar-brand">Welcome <font color="#7eaefc"> <?php echo $_SESSION['sadmun']; ?>!</font> You are logged in as <?php echo $_SESSION['admty']; ?> <a href="logout.php">Logout</a></a>
    </div>
