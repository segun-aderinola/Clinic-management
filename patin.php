...
<li style="font-family:calibri; font-size:16px;"><a style="color:#000" href="patinfo.php"><strong>Patient Information</strong></a></li>
...
<div class="container">
<div class="row">
<div class="col-md-4 col-md-push-4 col-xs-12 alert alert-success text-center">Patients Registered on this forum direct connected to the out-patient department of Hospital and Doctors.</div>
</div>
</div>
  ...
  <tr>
    <td colspan="2" style="padding:5px">
      <div class="input-group col-md-12 col-xs-12 "> 
        <span style="border-radius:0px; width:10px" class="input-group-addon" id="basic-addon1">+234</span>
        <input  pattern="\d{11,11}"  maxlength="11" title="Invalid Mobile Number. Use only Letters and character count must be 11" name="tel" required  type="text" class="form-control" placeholder="Contact Number" style="border-radius:0px">
    </div>
...
document.write('<?php echo $conduperr; ?>');
  ...
  <tr>
	...
	<script type="text/javascript">
   document.write('<?php echo $emlduperr; ?>');</script></td>
    </tr>
  <tr>
