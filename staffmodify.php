...
<li style="font-family:calibri; font-size:16px;"><a style="color:#000" href="patientmodify.php"><strong>Patient Information Modify</strong></a></li>
<li style="font-family:calibri; font-size:16px;"><a style="color:#000" href="#"><strong>Staff Information Modify</strong></a></li>
</ul>
</div></div>
...
if (isset($_POST['filter'])){
	...
	$self_query = "SELECT * FROM `staff` WHERE concat(`staffID`, `smtel`,`smemail`,`staff_fname`,`smtype`,`smwoti`) like '%$search%' ORDER BY `staffID` DESC";
...
<br>
  ...
  <dd style="font-size:12px;"><input name="pfname" id="patifn" disabled style="margin:5px" class="form-control" type="text" value="<?php echo $row["staff_fname"]; ?>"></dd>
<br>

  <dt style="font-size:12px;"><strong>Patient Last Name : </strong> </dt>
  <dd style="font-size:12px;"><input name="psname" id="patsn" disabled style="margin:5px" class="form-control" type="text" value=" <?php echo $row["staff_lname"]; ?>"></dd>
  ...
  <dd style="font-size:12px;"><input name="padd" id="addr" disabled style="margin:5px" class="form-control" type="text" value="<?php echo $row["insert_by"]; ?>"></dd>

  <dt style="font-size:12px;"><strong>Inserted Date and Time: </strong></dt>
  <dd style="font-size:12px;"><input name="padd" id="addr" disabled style="margin:5px" class="form-control" type="text" value="<?php echo $row["insert_date"]; ?>"></dd>
...
<dl>
  ...
  <li style="background-color:rgba(255, 255, 255, 0.3);"><a href="staffupdate.php?id=<?php echo $row["staffID"]; ?>" style="color:#000">Update</a></li>
  <li style="background-color:rgba(255, 255, 255, 0.3);"><a href="deletestf.php?id=<?php echo $row["staffID"]; ?>" style="color:#000">Delete</a></li>
  </ul>
...
<footer>
	<hr />
    <center><h5 style="color:#FFF">Developed by Aderinola Segun James (Lozkey)</h5><center>
</footer>
</html>
