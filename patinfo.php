...
<li class="active" style="font-family:calibri; font-size:16px;"><a style="color:#000" href="patinfo.php"><strong>Patient Information</strong></a></li>
...
<div class="row">
<div class="col-md-12 ">
<h4 style="font-family:calibri;" class="text-center">By Clicking more information can get informtion about channeled doctor, by clicking Make OPD Invoice can make basic invoice, by clicking on Admite to Hospital can admit patient to hospital.</h4>
<br />
...
<tr valign="middle">
    ...
    <td align="left"><?php echo $row["pat_reg_id"]; ?></td>
