...
$get_date = date("Y-m-d");
$pet_age = date_diff(date_create($get_date), date_create($petbd))->format("%y");
...
header("Location: patientmodify.php");
}
?>
...
<form class="" action="" method="post" id="upform">
  ...
  <input pattern="\d{11,11}"  maxlength="11" title="Envalid Mobile Number Use only Letters and chacter count must be 9" required="required" name="ptel" id="tel" type="text" class="form-control" value="<?php echo $row["pet_con"]; ?>" placeholder="Username" aria-describedby="basic-addon1 ">
</dd>
